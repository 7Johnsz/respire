...
export default function About() {
  return (
      // Padding da seção ajustado para responsividade
      <section className="bg-white py-12 px-4 md:py-16 lg:py-24">
        {/* Grid principal: espaçamento ajustado e mantém 2 colunas em telas grandes */}
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          {/* Coluna da Esquerda: Conteúdo principal (texto e vídeo) */}
          <div className="lg:sticky lg:top-24 lg:h-fit">
            {/* Cabeçalho: tamanho da fonte responsivo e margens ajustadas */}
            ...
            {/* Parágrafo principal: tamanho da fonte responsivo e margens ajustadas */}
            ...
            {/* Container do vídeo: altura ajustada para diferentes breakpoints */}
          ...
          {/* Grid dos cards: 1 coluna em mobile, 2 colunas a partir de sm:, espaçamento ajustado */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            {/* Card 1: padding interno ajustado */}
            ...
            {/* Card 2: padding interno ajustado */}
            <div className="bg-sage/10 hover:bg-sage/20 transition-colors rounded-xl shadow-sm p-4 sm:p-5 text-left">
              <div className="mb-3">
                <div className="w-8 h-8 bg-sage/30 text-sea-green rounded-full flex items-center justify-center">
            ...
            {/* Card 3: padding interno ajustado */}
            <div className="bg-sage/10 hover:bg-sage/20 transition-colors rounded-xl shadow-sm p-4 sm:p-5 text-left">
              <div className="mb-3">
                <div className="w-8 h-8 bg-sage/30 text-sea-green rounded-full flex items-center justify-center">
            ...
            {/* Card 4: padding interno ajustado */}
            <div className="bg-sage/10 hover:bg-sage/20 transition-colors rounded-xl shadow-sm p-4 sm:p-5 text-left">
              <div className="mb-3">
                <div className="w-8 h-8 bg-sage/30 text-sea-green rounded-full flex items-center justify-center">
                  <Leaf className="w-4 h-4" />
